...
class UseOracleOfficeWeatherControllerTest {
    ...
    private static final ForecastView FORECAST_VIEW = new ForecastView("Austin", """
    ...
    @Test
    void weatherForecast(@Client("/") HttpClient httpClient) {
        when(weatherChatBot.forecast(new Location(austinLatitude, austinLongitude))).thenReturn(FORECAST_VIEW);
        BlockingHttpClient client = httpClient.toBlocking();
        var request = HttpRequest.GET("/weather/austin/forecast").accept(MediaType.TEXT_HTML);
